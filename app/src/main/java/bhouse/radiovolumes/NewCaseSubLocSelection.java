...
public class NewCaseSubLocSelection extends DialogFragment {
    ...
    public static NewCaseSubLocSelection newInstance(String title) {
        NewCaseSubLocSelection dialog = new NewCaseSubLocSelection();
