 ...
 * Zooming view.
 */
public class ZoomView1 extends FrameLayout {

    public ZoomView1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
    }

    public ZoomView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
    }

    public ZoomView1(final Context context) {
        super(context);
    }
