...
public class ScannerListAdapter_1 extends ArrayAdapter<Slice> implements AreaDialog.OnCancelListener {
    ...
    public ScannerListAdapter_1(Context context, ArrayList<Slice> slices, ListView lv, LinkedHashMap<String, ArrayList<String>> oLimits) {
